...
//Way to do without json //But only for 1 testdata not multiple
customTest("Place Order", async ({ page ,testDataFororder}) => { //To specify name of test run when multiple testdata
        ...
        await dashboardPage.selectProductAddCart(testDataFororder.productName);
       ...
       await  page.waitForLoadState("networkidle");
        ...
        await expect(page.locator(".user__name [type='text']").first()).toHaveText(testDataFororder.email);
