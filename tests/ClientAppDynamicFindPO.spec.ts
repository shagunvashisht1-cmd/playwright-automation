...
import { POManager } from "../pageObjects_ts/POManager"; //this is the way to import the file when we are using module.exports in the js file. We can also use other methods like import, etc. depending on our needs. This is especially useful when we want to use the page object model in our tests.
